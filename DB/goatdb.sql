...
INSERT INTO `event` (`id`, `description`, `start_time`, `end_time`, `max_capacity`, `number_of_tickets`, `venue_id`, `title`, `image`, `event_date`, `created_at`, `last_update`) VALUES (13, 'A daylight savings time party. We will do lots of weird things between the hours of 2-3 am, but then it will go back to 2 am and it\'ll be like what we did never happened. But it did. Or it didnt?', '19:00:00', '25:00:00', 1400, 1400, 6, 'Daylight Savings Time Party', NULL, '2020-11-10', NULL, NULL);
