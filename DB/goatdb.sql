...
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `address_id`, `first_name`, `last_name`, `profile_pic`, `email`) VALUES (9, '1', '1', 1, 'Administrator', 9, 'Sammitty ', 'Sam', NULL, 'looneyToon@SD.com');
COMMIT;
...
INSERT INTO `event` (`id`, `description`, `start_time`, `end_time`, `max_capacity`, `number_of_tickets`, `venue_id`, `title`, `image`, `event_date`, `created_at`, `last_update`) VALUES (4, 'An emo poetry reading night with vegan snacks. Everybody is welcome!', '19:00:00', '22:00:00', 55, 55, 5, 'Emo Poetry', NULL, '2020-11-26', NULL, NULL);
INSERT INTO `event` (`id`, `description`, `start_time`, `end_time`, `max_capacity`, `number_of_tickets`, `venue_id`, `title`, `image`, `event_date`, `created_at`, `last_update`) VALUES (5, 'A one hour yoga class to all the hits of female rock and roll artists.', '17:00:00', '19:00:00', 35, 35, 3, 'Rock and Roll Yoga', NULL, '2020-11-20', NULL, NULL);
...
INSERT INTO `event` (`id`, `description`, `start_time`, `end_time`, `max_capacity`, `number_of_tickets`, `venue_id`, `title`, `image`, `event_date`, `created_at`, `last_update`) VALUES (DEFAULT, 'A lovely afternoon where we talk about Java, with a cup of java.', '19:00:00', '22:00:00', 50, 50, 2, 'Java over Java', NULL, '2020-11-05', NULL, NULL);
